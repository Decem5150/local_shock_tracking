...
pub fn get_legendre_points_interval(points_num: usize) -> (Array<f64, Ix1>, Array<f64, Ix1>) {
    let (gauss_points, gauss_weights) = match points_num {
        ...
        6 => {
            let points = array![- 0.9324695142031521, - 0.6612093864662645, - 0.2386191860831969, 0.2386191860831969, 0.6612093864662645, 0.9324695142031521];
            let weights = array![0.1713244923791704, 0.3607615730481386, 0.4679139345726910, 0.4679139345726910, 0.3607615730481386, 0.1713244923791704];
            (points, weights)
        }
